...
namespace MatForum.IdentityServer.Application.Services
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public AuthenticationService(UserManager<AppUser> userManager, IConfiguration configuration, IdentityServerDbContext dbContext)
        {
        ...
        public async Task<AppUser?> ValidateUser(UserCredentialsDto userCredentials)
        {
        ...
        public async Task<AuthenticationModel> CreateAuthenticationModel(AppUser user)
        {
        ...
        private async Task<RefreshToken> CreateRefreshToken()
        {
            ...
            var token = new RefreshToken
            {
                ...
                ExpiryTime = DateTime.UtcNow.AddDays(Convert.ToDouble(_configuration.GetValue<string>("RefreshTokenExpires")))
            };
